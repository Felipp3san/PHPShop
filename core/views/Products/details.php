...
<div class="container-fluid">
    ...
    <div class="row gap-3">
                ...
                <div class="carousel-inner">
                    <?php for ($i = 0; $i < sizeof($pictures) - 1; $i++) : ?>
                        <div class="carousel-item <?php if ($i == 0) echo 'active' ?> p-5">
                            <img src="assets/images/produtos/<?= $pictures[$i] ?>" class="d-block w-100" alt="...">
                        </div>
                    <?php endfor ?>
                </div>
        ...
        <div class="col product-card shadow-sm p-4 d-flex flex-column justify-content-between">
            <div>
                <!-- Fabricante -->
                <p class="fs-4 m-0"><?= $product->nome_fabricante ?></p>
                <!-- Nome -->
                <h2 class="mb-4"><?= $product->nome ?></h2>
                <!-- Descrição -->
                <p class="fs-5" style="text-align: justify;"><?= $product->descricao ?></p>
            </div>
            ...
            <div class="d-flex flex-column gap-3">
                <div class="row">
                    ...
                    <?php if ($product->quantidade > 10) : ?>
                        <div class="text-success d-flex align-items-center gap-2 justify-content-end">
                            ...
                            <span class="fs-3">Disponível</span>
                        </div>
                ...
                <!-- Preço -->
                <div class="row">
                    <span class="product-price fs-1 fw-bold mb-0 d-flex justify-content-end"><?= $product->preco ?> €</span>
                </div>
                            ...
                            <div class="col">
                                <?php if (Favorite::verify_favorite($_SESSION['customer_id'], $product->id)) : ?>
                                    <form action="?a=remove_favorite" method="POST">
                                        ...
                                        <button class="btn btn-link p-0 fs-2 resize-hover" type="submit">
                ...
                <div class="row d-flex">
                    <div class="col-7">
                        ...
                        <button type="button" class="btn btn-success rounded-0 w-100 fs-4">Adicionar ao Carrinho</button>
                    </div>
                    <div class="col-5">
                        <!-- COMPRAR JÁ -->
