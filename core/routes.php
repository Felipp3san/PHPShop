...
$routes = [
    ...
    'edit_product' => 'AdminController@edit_product',
    'remove_product' => 'AdminController@remove_product',
    ...
    // Order
    'order_details' => 'OrderController@order_details',
    'order_list' => 'OrderController@order_list',
